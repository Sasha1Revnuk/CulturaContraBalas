...
@section('pageContent')
    ...
    <form method="post" action="{{route('admin.stories.update', ['story' => $story])}}" enctype="multipart/form-data"
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-8">
                <x-admin.card :withHeader="true" :withFooter="true">
                    ...
                    <x-slot name="body">
                        @include('admin.stories.__form', ['storyTranslations' => $story->translations])
