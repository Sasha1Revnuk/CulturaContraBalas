...
Route::group(["middleware" => ['locale']], function () {
    ...
    Route::get('/projects', [\App\Http\Controllers\Web\EventController::class, 'index'])->name('events.index');
    Route::get('/project/{event:slug}', [\App\Http\Controllers\Web\EventController::class, 'single'])->name(
        'events.single'
    );
